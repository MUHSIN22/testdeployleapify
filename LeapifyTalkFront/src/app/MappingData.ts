export const MappingData = [
    { mapping: "Specialites", choices: ['Stress', 'Anxiety', 'Relationship issues', 'Trauma and abuse', 'Anger management', 'Depression',

     'Family conflicts', 'Parenting issues', 'Family problems', 'Eating disorders', 'Compulsions/OCD', 'Attachment issues', 'Guilt and shame', 'Self esteem', 'Domestic violence', 'Isolation/loneliness', 'Career difficulties', 'Mood disorders', 'Sleeping disorders', 'Bipolar disorder'
    ...
    { mapping: "Therapy", choices: ['Client-Centered Therapy', 'Cognitive Behavioral Therapy (CBT)', 'Dialectical Behavior Therapy (DBT)', 'Mindfulness Therapy', 'Motivational Interviewing', 'Solution-Focused Therapy', 'Trauma-Focused Therapy',], type: "checkbox", },
];